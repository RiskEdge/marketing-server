...
class MarketingTasks:
    # def marketing_management(self, agent: Agent, description: str, expected_output: str, context: ContextModel) -> Task:
        # return Task(
    ...
    def marketing_analysis(self, agent: Agent, description: str, expected_output: str, context) -> Task:
    # def marketing_analysis(self, agent: Agent, context: MarketingModel) -> Task:
    
        try:
            description = dedent(description).format(**context.model_dump())
            expected_output = expected_output.format(**context.model_dump())
    ...
    def content_creation(self, agent: Agent, description: str, expected_output: str, context) -> Task:
        try:
            description = dedent(description).format(**context.model_dump())
            expected_output = expected_output.format(**context.model_dump())
    ...
    def SEO(self, agent: Agent, description: str, expected_output: str, context) -> Task:
